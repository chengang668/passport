 ...
 */
@Entity
@Table(name = "log4port", catalog = "passport")
public class Log4port implements java.io.Serializable {
	...
	/** minimal constructor */
	public Log4port(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public Log4port(Integer id, String host, String facility, String priority,
